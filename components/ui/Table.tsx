...
import { ActivityAlertLogType, LogsByDateType, TableProps } from "../../models/models";

export default function Table({ selected, inputText }: TableProps) {
  const [logsByDate, setLogsByDate] = useState<LogsByDateType | null>();
  ...
  return (
    <div className="relative overflow-x-auto mt-2">
      {logsByDate && Object.keys(logsByDate).map((dateLabel, i) => (
        <div key={i}>
